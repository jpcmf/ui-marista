...
plugins.push(new htmlWebpackPlugin({
  ...
  filename: 'instituto-capitulos-nairobi.html',
  template: __dirname + '/instituto-capitulos-nairobi.html'
}));
...
plugins.push(new htmlWebpackPlugin({
  ...
  filename: 'instituto-capitulos-mendes.html',
  template: __dirname + '/instituto-capitulos-mendes.html'
}));
